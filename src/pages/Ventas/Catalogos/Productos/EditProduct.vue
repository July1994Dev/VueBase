...
const { ActiveProduct, IsEdit, Products, ShowForm } = storeToRefs(useProductsStore());
...
<template>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-12">
                    <label>Codigo</label>
                    <input v-if="IsEdit" disabled v-bind:value="ActiveProduct.codigo" type="text"
    ...
    <div class="row text-center">
        <div class="col"> <button type="button" class="btn btn-secondary mr-3" @click="Cancelar"
